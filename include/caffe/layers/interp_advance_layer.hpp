#ifndef CAFFE_INTERP_ADVANCE_LAYER_HPP_
#define CAFFE_INTERP_ADVANCE_LAYER_HPP_
...
class InterpAdvanceLayer : public Layer<Dtype> {
 public:
  explicit InterpAdvanceLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "InterpAdvance"; }
...
#endif  // CAFFE_INTERP_ADVANCE_LAYER_HPP_
